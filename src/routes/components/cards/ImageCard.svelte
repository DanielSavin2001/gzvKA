...
<div class="space-y-4 mx-auto h-auto">
	<Card img={imageUrl}>
		<h5
			class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 dark:text-white"
		>
			{imageDocument.imageName}
		</h5>
		<p class="mb-3 font-normal text-gray-700 dark:text-gray-300 dark:text-gray-400 leading-tight">
			Description: {imageDocument.imageDescription ? imageDocument.imageDescription : '/'}
		</p>
		<p class="mb-3 font-normal text-gray-700 dark:text-gray-300 dark:text-gray-400 leading-tight">
			Year of image: {imageDocument.yearOfImage ? imageDocument.yearOfImage : '/'}
		</p>
